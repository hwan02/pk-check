...
export default function SnkrSearch() {
  ...
  return (
    <div>
      ...
      {items.length > 0 && <p className="text-sm opacity-60 mb-3">{items.length}개 결과</p>}
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  {item.url && (
                    <a href={item.url} target="_blank" rel="noopener noreferrer" className="text-xs text-[var(--primary)] hover:underline">
                      snkrdunk에서 보기
                    </a>
                  )}
                </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition flex-shrink-0 cursor-pointer ${
                  isAdded ? "bg-green-100 text-green-700" : isAdding ? "bg-gray-200 text-gray-500" : "bg-[var(--primary)] text-white hover:opacity-90"
                }`}
              >
